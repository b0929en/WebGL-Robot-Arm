...
function init() {
  ...
  // Sliders (smooth update)
  document.getElementById("slider1").oninput = e => theta[Base] = e.target.value;
  document.getElementById("slider2").oninput = e => theta[LowerArm] = e.target.value;
  document.getElementById("slider3").oninput = e => theta[UpperArm] = e.target.value;
